    ...
    return (
        <div className=' '>
            <form action="" className="flex flex-col w-100 h-80">
                <input type="text" placeholder='Логин' name="" id="" className="border-2 border-[#6c5ce7] rounded-xl 
                            p-1 m-3 h-12 
                            focus:outline-none focus:ring-1 focus:ring-[#6c5ce7]"/>
                <input type="password" placeholder='Пароль' name="" id="" className="border-2 border-[#6c5ce7] rounded-xl 
                            p-1 m-3 h-12
                            focus:outline-none focus:ring-1 focus:ring-[#6c5ce7]" />
                <button type='submit'
